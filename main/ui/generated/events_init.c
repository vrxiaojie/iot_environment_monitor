...
static void setting_screen_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        case LV_DIR_TOP:
        {
            ...
            ui_load_scr_animation(&guider_ui, &guider_ui.main_screen, guider_ui.main_screen_del, &guider_ui.setting_screen_del, setup_scr_main_screen, LV_SCR_LOAD_ANIM_MOVE_TOP, 400, 0, false, true);
            break;
        }
        default:
            break;
...
static void main_screen_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.setting_screen, guider_ui.setting_screen_del, &guider_ui.main_screen_del, setup_scr_setting_screen, LV_SCR_LOAD_ANIM_MOVE_BOTTOM, 400, 0, false, true);
            break;
        }
        default:
            break;
