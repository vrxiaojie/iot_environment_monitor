...
typedef struct
{
	...
	lv_obj_t *ota_screen;
	bool ota_screen_del;
	lv_obj_t *ota_screen_wifi_container;
	lv_obj_t *ota_screen_label_1;
	lv_obj_t *ota_screen_url_input;
	lv_obj_t *ota_screen_label_2;
	lv_obj_t *ota_screen_label_3;
	lv_obj_t *ota_screen_label_4;
	lv_obj_t *ota_screen_label_6;
	lv_obj_t *ota_screen_label_5;
	lv_obj_t *ota_screen_updateing_label;
	...
	lv_obj_t *ota_screen_update_percent_bar;
